...
function AirPollution({ coords }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="text-5xl font-semibold">{data.list[0].components.pm2_5}</h1>
      <div className="flex items-center gap-2">
        <h1 className="text-2xl font-semibold">AQI (US EPA)</h1>
        <Tooltip>
          <TooltipTrigger>
          ...
          <TooltipContent className="z-2000">
            <p className="max-w-xs">
              Air Quality Index (US EPA standard). 0-50: Good, 51-100: Moderate, 
...
const airQualityRanges: AirQualityRanges = {
  ...
  PM2_5: {
    ...
    Poor: { min: 151, max: 200 },
    "Very Poor": { min: 201, max: null },
  },
  O3: {
    Good: { min: 0, max: 60 },
    Fair: { min: 60, max: 100 },
...
const pollutantNameMapping: Record<Pollutant, string> = {
  ...
  PM2_5: "US EPA Air Quality Index (based on PM2.5)",
  O3: "Ozone",
  CO: "Carbon monoxide",
