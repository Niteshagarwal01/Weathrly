...
function App() {
  ...
  const { data: geocodeData } = useQuery({
    ...
    enabled: location !== "Current Location" && location !== "custom",
  })
  ...
  const coords =
    location === "custom" || location === "Current Location"
      ? coordinates
        ...
        <div className="flex flex-col gap-4 xs:flex-row xs:gap-8">
          ...
          <div className="ml-auto flex gap-4 items-center">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-border bg-background hover:bg-accent transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
